...
* manifest.json 声明了 background.service\_worker: "background.js"，但仓库中不存在该文件。
...
* 在 manifest.json 添加 browser\_specific\_settings.gecko：

  * id（固定扩展 ID，便于更新）

  * strict\_min\_version（如 "109.0"，匹配 MV3 支持）
